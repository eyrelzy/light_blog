...
<div id="wrapper">
  <div id="container">
    <div id="scene"> <img src="../images/scene.jpg" alt="" />
      <h1>${empty sessionScope.blogtitle ? "博客系统":sessionScope.blogtitle} <br/>
      		<font size="8">${empty sessionScope.idiograph ? "签名":sessionScope.idiograph}</font>
      		</h1>
      <div id="scale_area">
      ...
      <div id="menu">
        ...
        <div class="holder"> <a href="addArticle.jsp">吐槽</a> </div>
            ...
            <table cellspacing="5" align="center" border="1">
           	...
           	<s:iterator value="#request.photoList" id="photo" status="stu">
				<td>
					...
					<a href="DownLoad.action?fileName=user/photo/${sessionScope.username}/<s:property value="photo"/>">下载</a> 
				</td>
