			...
			<table width="1000" border="0" cellpadding="0" cellspacing="0">
				...
				<%
				 ...
				 %>
					...
					<td class="ltsep">|</td>
					<td class="lt0" onmouseenter="mhEnter()" onmouseleave="mhLeave()"><a href="addArticle.jsp">吐个槽</a></td>
					<td class="ltsep">|</td>
					<td class="lt0" onmouseenter="mhEnter()" onmouseleave="mhLeave()"><a href="showPhoto.action">云相册</a></td>
					<td class="ltsep">|</td>
					<td class="lt0" onmouseenter="mhEnter()" onmouseleave="mhLeave()"><a href="editbloginfo.jsp">主题设置</a></td>
					<td class="ltsep">|</td>
				</tr>
				 <%
				 	}
