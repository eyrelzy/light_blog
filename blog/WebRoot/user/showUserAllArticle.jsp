...
<div id="wrapper">
  <div id="container">
    <div id="scene"> c<img src="../images/scene.jpg" alt="" />
       <h1>${empty sessionScope.blogtitle ? "吐槽系统":sessionScope.blogtitle} <br/>
      ...
      <div id="menu">
       ...
       <div class="holder"> <a href="showUserAllArticle.action">用户首页</a>
          ...
          <div class="holder"> <a href="../main.jsp">首页</a>
         </div>
            ...
            <div class="comment alt">
              <div class="meta"><span class="datetime">
              	<!-- 发表时间 -->
														...
														|<a href="deleteArticle.action?id=<s:property value='#art.id'/>">删除</a>
														|<a href="editArticle.action?username=<s:property value='#art.username'/>&id=<s:property value='#art.id'/>">编辑</a>
              </span>
                <div class="clear"> </div>
              </div>
            </div>
